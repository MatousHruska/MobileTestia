...
func _create_header() -> Control:
	...
	points_label.add_theme_color_override("font_color", UITheme.COLOR_AVAILABLE)
	...
	skill_points_label.add_theme_color_override("font_color", UITheme.COLOR_HIGHLIGHT)
	...
	xp_bar.name = "XPBar"
	xp_bar.custom_minimum_size = Vector2(0, UITheme.BAR_HEIGHT_NORMAL)
...
func _create_attribute_row(abbrev: String, stat_name: String) -> Array:
	...
	label.flat = true
	label.text = abbrev + ":"
	label.custom_minimum_size = Vector2(UITheme.LABEL_WIDTH_NORMAL, 0)
	...
	value.text = "10"
	value.custom_minimum_size = Vector2(UITheme.LABEL_WIDTH_SMALL, 0)
	...
	plus_btn.text = "+"
	plus_btn.custom_minimum_size = Vector2(UITheme.BUTTON_HEIGHT_SMALL, UITheme.BUTTON_HEIGHT_SMALL)
...
func _create_subtab_bar() -> Control:
	...
	for i in range(tabs.size()):
		...
		btn.custom_minimum_size = Vector2(UITheme.BUTTON_WIDTH_SMALL, UITheme.BUTTON_HEIGHT_SMALL)
...
func _create_effects_section() -> Control:
	...
	_effects_title_label.add_theme_color_override("font_color", UITheme.COLOR_TEXT_DIM)
	...
	_no_effects_label.add_theme_color_override("font_color", UITheme.COLOR_LOCKED)
...
func _create_effect_icon(effect_type: String, effect_data: Dictionary) -> Button:
	...
	var border := float(UITheme.BORDER_WIDTH_THICK)
	var bar_height := float(UITheme.MARGIN_SMALL)
	...
	duration_bar.custom_minimum_size.y = UITheme.BAR_HEIGHT_THIN
	...
	timer_label.offset_top = -UITheme.SEPARATION_TINY  # Adjust for duration bar
	...
	timer_label.add_theme_constant_override("shadow_offset_x", UITheme.BORDER_WIDTH_NORMAL)
	timer_label.add_theme_constant_override("shadow_offset_y", UITheme.BORDER_WIDTH_NORMAL)
...
func _create_derived_stat_row(stat_name: String, display_name: String) -> Array:
	...
	value.text = "0"
	value.custom_minimum_size = Vector2(UITheme.LABEL_WIDTH_LARGE, 0)
