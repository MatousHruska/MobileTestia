...
func _generate_sprite_frames_resource() -> void:
	## Uses load() + AtlasTexture to reference external PNGs instead of
	## embedding pixel data. Keeps .tres tiny (~15 KB vs 1.4 MB).
	...
	for anim_name in ANIM_DEFS:
		...
		# Use AtlasTexture to reference frame regions from the shared sheet
