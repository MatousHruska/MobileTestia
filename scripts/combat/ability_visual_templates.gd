...
static func _melee_single() -> AbilityVisualData:
	...
	data.phases = [
		...
		# Phase 3: Lunge toward target (concurrent with strike)
		AbilityVisualPhase.create_movement("toward_target", 20.0, 0.10, "lunge", true),
		# Phase 4: Strike — short duration so damage fires mid-swing
		AbilityVisualPhase.create_body_anim("melee_strike", 0.08),
		# Phase 5: Damage event (fires while swing is still in motion)
...
static func _melee_combo_2() -> AbilityVisualData:
	...
	data.phases = [
		...
		AbilityVisualPhase.create_effect("slash_arc"),
		# Phase 3: Lunge + strike (concurrent)
		AbilityVisualPhase.create_movement("toward_target", 20.0, 0.10, "lunge", true),
		AbilityVisualPhase.create_body_anim("melee_strike", 0.08),
		# Phase 5: First hit damage (mid-swing)
		AbilityVisualPhase.create_damage_event(),
		...
		# Phase 8: Second strike — short duration for mid-swing hit
		AbilityVisualPhase.create_body_anim("melee_strike", 0.08),
