...
Public Sub ExportConsumables()
    ...
    For i = 2 To lastRow
        ...
        json = json & "      ""effect_value"": " & GetDefaultNumeric(ws.Cells(i, COL_CON_EFFECT_VALUE)) & "," & vbCrLf
        json = json & "      ""duration"": " & GetDefaultNumeric(ws.Cells(i, COL_CON_DURATION)) & "," & vbCrLf
        json = json & "      ""cooldown"": " & GetDefaultNumeric(ws.Cells(i, COL_CON_COOLDOWN)) & "," & vbCrLf
        json = json & "      ""stack_size"": " & GetDefaultNumeric(ws.Cells(i, COL_CON_STACK_SIZE), 20) & "," & vbCrLf
        json = json & "      ""price_base"": " & GetDefaultNumeric(ws.Cells(i, COL_CON_PRICE_BASE), 10) & vbCrLf
        json = json & "    }"
...
Public Sub ExportStatusEffects()
    ...
    For i = 2 To lastRow
        ...
        json = json & "      ""value"": " & GetDefaultNumeric(ws.Cells(i, COL_SE_VALUE)) & "," & vbCrLf
        json = json & "      ""duration"": " & GetDefaultNumeric(ws.Cells(i, COL_SE_DURATION)) & "," & vbCrLf
...
Public Sub ExportZones()
    ...
    For i = 2 To lastRow
        ...
        json = json & "      ""min_level"": " & GetDefaultNumeric(ws.Cells(i, COL_ZN_MIN_LEVEL), 1) & "," & vbCrLf
        json = json & "      ""max_level"": " & GetDefaultNumeric(ws.Cells(i, COL_ZN_MAX_LEVEL), 100) & "," & vbCrLf
