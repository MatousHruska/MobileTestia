...
const DEFAULTS := {
	...
	# Font sizes (base values for 270p design, scaled by ui_scale)
	# At 720p (ui_scale ~2.67): title=24px, header=19px, label=16px, small=13px
	"font_size_title": 9,
	"font_size_large": 8,
	"font_size_header": 7,
	"font_size_label": 6,
	"font_size_small": 5,
	"font_size_tiny": 4,
	# Margins (scaled by ui_scale for native resolution)
	"margin_standard": 4,
	"margin_small": 3,
	"margin_tiny": 2,
	# Border widths
	...
	# Corner radii
	"corner_radius_normal": 2,
	"corner_radius_small": 2,
	"corner_radius_popup": 3,
	# Separations
	"separation_normal": 4,
	"separation_small": 2,
	"separation_tiny": 1,
